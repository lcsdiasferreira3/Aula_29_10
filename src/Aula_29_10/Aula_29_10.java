...
public class Aula_29_10 extends JFrame{
	JLabel lblNome = new JLabel("Nome: ");
	JLabel lblende = new JLabel("Endereco: ");
	...
	public Aula_29_10() {
		...
		paine.add(lblende);
		lblende.setBounds(20,40,100,20);
		
		paine.add(txtende);
		txtende.setBounds(130,40,200,20);
		
		paine.add(lblCID);
		lblCID.setBounds(20,60,200,20);
	...
	public static void main(String args[]) {
		Aula_29_10 tela = new Aula_29_10();
